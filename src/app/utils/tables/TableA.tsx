...
export default function TableA({profiles}: {profiles:ProfileType[]}) {
    ...
    return (
        <table className="text-left border border-slate-300 shadow-md rounded-lg overflow-x-scroll table-auto w-full">
            <thead className="h-14">
                <tr>
                    ...
                    <th className="border border-slate-300 bg-slate-50 text-center">Tipo</th>
                    <th className="border border-slate-300 bg-slate-50 text-center">Estado</th>
                    <th className="border border-slate-300 bg-slate-50 text-center">Rol</th>
