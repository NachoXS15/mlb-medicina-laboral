											...
											>
												{monthDocs.map(
													(doc: DocType) => (
														<div
															key={doc.id}
															className="py-2 flex flex-col md:flex-row gap-2 justify-between items-center border px-4 border-dashed border-slate-200"
														>
															<div className="">
															...
															<div className="flex items-center justify-center gap-5 text-xs px-0 md:px-15 w-full md:w-35">
																<span className="hover:scale-105 transition cursor-pointer flex items-center gap-2 bg-green-200 px-5 py-2 rounded">
																	Descargar{" "}
																	<DownloadButton
																		size={
																			20
