        ...
        <section className='text-black w-[650px] h-[550px] shadow-xl'>
            ...
            <section className='mt-5 flex gap-10 flex-col items-center justify-center'>
                ...
                <form action="" className='w-full flex items-center flex-col gap-5'>
                    ...
                    <Link href="/admin/dashboardA" className='mt-5 bg-bronze flex justify-center items-center text-white w-4/5 h-10 rounded-2xl transition border hover:border-bronze hover:bg-white hover:text-bronze'>Iniciar sesión</Link>
                </form>
                <div>
